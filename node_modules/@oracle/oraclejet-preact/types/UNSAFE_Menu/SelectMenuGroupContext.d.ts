...
declare type SelectSingleMenuGroupContextProps = {
    isMultiple: false;
    value?: string;
    onCommit?: (detail: MenuValueUpdateDetail<string>) => void;
};
declare type SelectMultipleMenuGroupContextProps = {
    isMultiple: true;
    value?: string[];
    onCommit?: (detail: MenuValueUpdateDetail<string[]>) => void;
};
declare type SelectMenuGroupContextProps = SelectSingleMenuGroupContextProps | SelectMultipleMenuGroupContextProps;
