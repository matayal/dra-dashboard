 ...
 * state.
 */
export declare function useSelectMultiple<K, D>({ data: propData, inputRef, isDisabled, isFocused: propIsFocused, isReadonly, onCommit, onFilter, onLoadRange: propOnLoadRange, valueItems }: UseSelectMultipleProps<K, D>): {
    collectionProps: {
