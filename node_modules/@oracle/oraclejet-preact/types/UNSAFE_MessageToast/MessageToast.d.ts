...
declare const positions: ("bottom" | "top" | "top-start" | "top-end" | "bottom-start" | "bottom-end" | "top-left" | "top-right" | "bottom-left" | "bottom-right")[];
 ...
 */
export declare type MessageToastItem = {
    /**
 ...
 */
export declare type MessageToastRendererDataItem<K, D> = {
    /**
