 ...
 */
export declare type Props<K, D> = Pick<ListProps<K, D>, 'accessibleSummary' | 'children' | 'currentItemVariant' | 'currentKey' | 'data' | 'gridlines' | 'onCurrentKeyChange' | 'onItemAction' | 'onLoadRange' | 'onSelectionChange' | 'selectedKeys' | 'selectionMode' | 'viewportConfig'>;
/**
