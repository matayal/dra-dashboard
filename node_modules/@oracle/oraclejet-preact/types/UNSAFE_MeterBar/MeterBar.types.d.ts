 ...
 */
export declare type MeterBarProps = {
    /**
    ...
    /**
     * One or more ids (separated by spaces) of elements that label the meter bar.
     */
    ariaLabelledBy?: string;
    /**
     * One or more ids (separated by spaces) of elements that describe the meter bar.
     */
