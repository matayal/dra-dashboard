...
export declare function Link({ href, variant, placement, target, ariaDescribedBy, accessibleLabel, ariaLabelledBy, children, onClick }: Props): import("preact").JSX.Element;
export {};
