...
declare type FilePickerProps = ComponentProps<typeof FilePicker>;
/**
 * Gets the default content of the file picker
 */
export declare const getDefaultTriggerContent: (isDisabled: FilePickerProps['isDisabled'], primaryText: FilePickerProps['primaryText'], secondaryText: FilePickerProps['secondaryText'], translations: BundleType, selectionMode: FilePickerProps['selectionMode']) => JSX.Element[];
/**
...
export declare const getAriaLabel: ({ accessibleLabel, isDisabled, translations, primaryText, secondaryText, selectionMode }: AriaLabelProps) => string;
/**
