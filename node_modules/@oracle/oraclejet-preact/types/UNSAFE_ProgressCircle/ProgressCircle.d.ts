...
declare type IntrinsicProps = Pick<HTMLAttributesSignalExcluded<HTMLDivElement>, 'id' | 'class' | 'children'>;
 ...
 */
export declare function ProgressCircle({ value, max, ...otherProps }: Props): import("preact").JSX.Element;
export {};
