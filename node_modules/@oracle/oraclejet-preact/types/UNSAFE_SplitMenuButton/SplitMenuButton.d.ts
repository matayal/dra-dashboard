...
declare type IntrinsicProps = Pick<HTMLAttributesSignalExcluded<HTMLElement>, 'title'>;
declare type WidthInterpolationProps = Pick<DimensionProps, 'width'>;
export declare type Props = IntrinsicProps & WidthInterpolationProps & {
    /**
