...
export declare type CircularRefLine = Omit<ReferenceLine, 'position'>;
export declare type CenterContext = {
    /**
...
/**
 * Props for Meter Gauge.
 */
export declare type MeterProps = {
    /**
     * The size of the meter circle.
     */
    size?: MeterSize;
    /**
    ...
    /**
     * Defines the distance between the center of the circle to the inner edge of the circular bar. Depends on the size of the gauge and theme.
     */
    innerRadius?: number;
    /**
    ...
    /**
     * Reference lines for the gauge value bar.
     * Applications are required to include information about reference lines for screen readers to make their component accessible by using ariaDescribedBy, ariaLabelledBy or accessibleLabel.
     */
    ...
    /**
     * One or more ids (separated by spaces) of elements that label the meter circle.
     */
    ariaLabelledBy?: string;
    /**
     *  One or more ids (separated by spaces) of elements that describe the meter circle.
     */
    ariaDescribedBy?: string;
    /**
     * The center content of the meter circle.
     * Applications are required to include information about visible text in their center content for screen readers to make their component accessible by using ariaDescribedBy, ariaLabelledBy or accessibleLabel.
     */
