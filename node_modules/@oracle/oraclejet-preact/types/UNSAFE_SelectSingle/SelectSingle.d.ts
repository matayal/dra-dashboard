...
declare type InlineUserAssistanceProps = ComponentProps<typeof InlineUserAssistance>;
declare type Props<K extends string | number, D extends Record<string, any>> = {
    /**
 ...
 */
export declare const SelectSingle: import("preact").FunctionalComponent<Omit<Props<string | number, Record<string, any>>, "ref"> & {
