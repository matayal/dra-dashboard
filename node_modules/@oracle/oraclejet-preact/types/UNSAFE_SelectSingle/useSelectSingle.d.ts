...
declare type PickedPropsFromSelectSingle = Pick<ComponentProps<typeof SelectSingle>, 'isDisabled' | 'isReadonly' | 'onFilter'>;
declare type UseSelectSingleProps<K, D> = PickedPropsFromSelectSingle & {
