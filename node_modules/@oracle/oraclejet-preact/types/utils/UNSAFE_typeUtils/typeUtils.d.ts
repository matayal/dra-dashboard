...
export declare type IntrinsicElement<T extends ElementType> = ExcludeSignalLike<JSX.IntrinsicElements[T]>;
export declare type StyleProps = Pick<HTMLAttributesSignalExcluded, 'class' | 'className' | 'style'>;
