...
const SvgIcoCaretDown = (props) => (jsx(Icon, Object.assign({ viewBox: "0 0 24 24" }, props, { children: jsx("path", { d: "m6 9 5.975 6L18 9H6z", fill: "currentcolor" }) })));

const SvgIcoCheck = (props) => (jsx(Icon, Object.assign({ viewBox: "0 0 24 24" }, props, { children: jsx("path", { d: "M20.616 5 9.564 16.196l-5.18-5.247L3 12.35 9.564 19 22 6.402z", fill: "currentcolor", fillRule: "evenodd" }) })));
...
const SvgIcoChevronUp = (props) => (jsx(Icon, Object.assign({ viewBox: "0 0 24 24" }, props, { children: jsx("path", { d: "M6.35 16 5 14.261 12 8l7 6.261L17.65 16 12 10.946z", fill: "currentcolor", fillRule: "evenodd" }) })));

const SvgIcoClose = (props) => (jsx(Icon, Object.assign({ viewBox: "0 0 24 24" }, props, { children: jsx("path", { d: "M17.524 5 19 6.476 13.475 12 19 17.524 17.524 19 12 13.475 6.476 19 5 17.524 10.525 12 5 6.476 6.476 5 12 10.525z", fill: "currentcolor", fillRule: "evenodd" }) })));
...
const SvgIcoNavDown = (props) => (jsx(Icon, Object.assign({ viewBox: "0 0 24 24" }, props, { children: jsx("path", { d: "M12 14.586 4.707 7.293 3.293 8.707 12 17.414l8.707-8.707-1.414-1.414L12 14.586z", fill: "currentcolor" }) })));
...
export { SvgCheckboxOff as CheckboxOff, SvgCheckboxOn as CheckboxOn, SvgIcoCaretDown as IcoCaretDown, SvgIcoCheck as IcoCheck, SvgIcoChevronDown as IcoChevronDown, SvgIcoChevronLeft as IcoChevronLeft, SvgIcoChevronRight as IcoChevronRight, SvgIcoChevronUp as IcoChevronUp, SvgIcoClose as IcoClose, SvgIcoErrorS as IcoErrorS, SvgIcoInformationS as IcoInformationS, SvgIcoNavDown as IcoNavDown, SvgIcoSuccessS as IcoSuccessS, SvgIcoView as IcoView, SvgIcoViewHide as IcoViewHide, SvgIcoWarningS as IcoWarningS };
/*  */
