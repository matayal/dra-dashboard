    ...
    for (let i = nextPosition; i > -1; i--) {
        ...
        if ((_c = (_b = ref === null || ref === void 0 ? void 0 : ref.current) === null || _b === void 0 ? void 0 : _b.focus) === null || _c === void 0 ? void 0 : _c.call(_b)) {
            ...
            if (currentFocusedMessage) {
                const { callbacks } = (_d = componentsMap.get(currentFocusedMessage)) !== null && _d !== void 0 ? _d : {};
                (_e = callbacks === null || callbacks === void 0 ? void 0 : callbacks.onFocusLeave) === null || _e === void 0 ? void 0 : _e.call(callbacks);
            }
...
function togglePreviousFocus(id, event) {
    ...
    const { callbacks } = (_a = componentsMap.get(id)) !== null && _a !== void 0 ? _a : {};
    if (target && document.body.contains(target)) {
        target.focus();
        // invoke callback to let the component know the focus is left
        (_b = callbacks === null || callbacks === void 0 ? void 0 : callbacks.onFocusLeave) === null || _b === void 0 ? void 0 : _b.call(callbacks);
