...
function convertUseAnimationCssPropertiesToRegularCSS(useAnimationCssProperties) {
    ...
    const { translateX, translateY, translateZ, rotateX, rotateY, rotateZ, scaleX, scaleY, scaleZ, skewX, skewY } = useAnimationCssProperties, otherCssProperties = __rest(useAnimationCssProperties, ["translateX", "translateY", "translateZ", "rotateX", "rotateY", "rotateZ", "scaleX", "scaleY", "scaleZ", "skewX", "skewY"]);
...
function convertUseAnimationCssPropertiesToWAAPIKeyframe(useAnimationCssProperties) {
    ...
    const _a = convertUseAnimationCssPropertiesToRegularCSS(useAnimationCssProperties), { offset } = _a, otherCssProperties = __rest(_a, ["offset"]);
...
function isVisible(element) {
    return !!((element === null || element === void 0 ? void 0 : element.offsetWidth) || (element === null || element === void 0 ? void 0 : element.offsetHeight) || (element === null || element === void 0 ? void 0 : element.getClientRects().length));
}
...
function useAnimation(animationState, { animationStates, isAnimatedOnMount = false, onAnimationEnd = () => { } }) {
    ...
    const animationStatesRef = useRef(animationStates);
    useEffect(() => {
        var _a;
        ...
        if (((_a = currentAnimation.current) === null || _a === void 0 ? void 0 : _a.playState) === 'running') {
    ...
    const callbackRef = useCallback((node) => {
        ...
        if (node != nodeRef.current) {
            ...
            if (nodeRef.current) {
                (_a = currentAnimation.current) === null || _a === void 0 ? void 0 : _a.cancel();
