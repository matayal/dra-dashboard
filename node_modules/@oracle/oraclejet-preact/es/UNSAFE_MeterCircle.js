...
function CircularReferenceLine({
  ...
  return jsx("div", {
    ...
    style: {
      ...
      backgroundColor: color ? getDvtThresholdColor(color) : 'var(--oj-c-PRIVATE-DO-NOT-USE-dvt-reference-object-line-color)',
...
function MeterCircle(_a) {
  ...
  var {
    ...
    indicatorSize = 1
      ...
      props = __rest(_a, ["max", "min", "value", "step", "size", "startAngle", "angleExtent", "isTrackRendered", "thresholdDisplay", "indicatorSize"]);
  ...
  const pointerEventsProps = usePointerEvents(value, getValueFromEvent, circleWrapperRef, props.onCommit, props.onInput);
  ...
  const ariaProps = getMeterAriaProps(value, min, max, `${value}`, props.accessibleLabel, props.ariaLabelledBy, props.thresholds);
  ...
  return jsxs(Fragment, {
    children: [jsx("div", Object.assign({
      ...
      children: jsxs(CircleWrapper, Object.assign({
        ref: circleWrapperRef,
        class: classNames([circleWrapper.base, props.referenceLines && props.referenceLines.length > 0 ? styles[`${size}${section}`] : '', styles[`${size}${orientation}`]])
      }, {
        children: [jsx(CircleInner, Object.assign({
          ...
          return jsx(CircularReferenceLine, Object.assign({}, getReferenceLinesProps(meterInfo, refLine, props.innerRadius), {
            section: section
          }));
        }), isDimsReady && props.children && centerContext && jsx("div", Object.assign({
          class: classNames([styles.centerContent, childrenStyles])
        }, {
