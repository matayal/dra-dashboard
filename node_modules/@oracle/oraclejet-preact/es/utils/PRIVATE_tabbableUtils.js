...
import { _ as _curry1_1 } from '../_curry1-ab762f3c.js';
import { _ as _curry2_1 } from '../_curry2-9cf34233.js';
import { _ as _curry3_1 } from '../_curry3-77af75f1.js';
...
const sortByTabIndex = (a, b) => {
    var _a, _b;
    const idxA = (_a = a.tabIndex) !== null && _a !== void 0 ? _a : 0;
    const idxB = (_b = b.tabIndex) !== null && _b !== void 0 ? _b : 0;
    return idxA - idxB;
};
...
const getActiveElement = (node) => {
    var _a;
    const conditionalDocument = (_a = node === null || node === void 0 ? void 0 : node.ownerDocument) !== null && _a !== void 0 ? _a : document;
