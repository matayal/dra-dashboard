...
import { _ as _has_1 } from '../_has-e54ed87c.js';
...
const mergeInterpolations = (interpolations) => (props) => interpolations.reduce((acc, fn) => mergeDeepWithKey_1(combineClassNames, acc, fn(props)), {});
