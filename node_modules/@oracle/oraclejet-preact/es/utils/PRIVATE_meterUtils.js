...
function getTrackColor(thresholdDisplay, currentThreshold, trackColor) {
    if (thresholdDisplay === 'track' && (currentThreshold === null || currentThreshold === void 0 ? void 0 : currentThreshold.color)) {
        return getDvtThresholdColor(currentThreshold === null || currentThreshold === void 0 ? void 0 : currentThreshold.color);
    }
    return trackColor;
}
/**
...
function getIndicatorColor(thresholdDisplay, currentThreshold, indicatorColor) {
    if ((currentThreshold === null || currentThreshold === void 0 ? void 0 : currentThreshold.color) && thresholdDisplay === 'indicator') {
 ...
 */
function getMeterAriaProps(value, min, max, valueText, accessibleLabel, ariaLabelledby, thresholds) {
    const currentThreshold = findThreshold(value, thresholds);
    const ariaValueText = `${valueText} ${(currentThreshold === null || currentThreshold === void 0 ? void 0 : currentThreshold.accessibleLabel) || ''}`;
    return {
...
function getThresholdColorFromValue(value, color, thresholds) {
    const currentThreshold = findThreshold(value, thresholds);
    if (currentThreshold === null || currentThreshold === void 0 ? void 0 : currentThreshold.color) {
        return currentThreshold === null || currentThreshold === void 0 ? void 0 : currentThreshold.color;
    }
    return color;
}
...
export { convertToPolar, findThreshold, getCenterCoord, getCircleSection, getClipPath, getMeterAriaProps, getPositiveAngle, getThresholdColorFromValue, getTrackAndIndicatorColor, validateRange };
/*  */
