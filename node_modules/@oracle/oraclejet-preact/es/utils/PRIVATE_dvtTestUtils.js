...
import { matchTranslationBundle } from './UNSAFE_matchTranslationBundle.js';
import { RootEnvironmentProvider } from '../UNSAFE_Environment.js';
...
const setupTabbableComponent = async (component, isTabbable) => {
    ...
    if (isTabbable !== undefined) {
        return render(jsx(RootEnvironmentProvider, Object.assign({ environment: env }, { children: jsx(TabbableModeContext.Provider, Object.assign({ value: { isTabbable: isTabbable } }, { children: component })) })));
    }
    else {
        return render(jsx(RootEnvironmentProvider, Object.assign({ environment: env }, { children: component })));
    }
};

export { setupTabbableComponent as default };
/*  */
