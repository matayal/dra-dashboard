...
var utils_UNSAFE_dvtCommonUtils = require('./UNSAFE_dvtCommonUtils.js');
...
function getTrackColor(thresholdDisplay, currentThreshold, trackColor) {
    if (thresholdDisplay === 'track' && (currentThreshold === null || currentThreshold === void 0 ? void 0 : currentThreshold.color)) {
        return utils_UNSAFE_dvtCommonUtils.getDvtThresholdColor(currentThreshold === null || currentThreshold === void 0 ? void 0 : currentThreshold.color);
    }
    return trackColor;
}
/**
...
function getIndicatorColor(thresholdDisplay, currentThreshold, indicatorColor) {
    if ((currentThreshold === null || currentThreshold === void 0 ? void 0 : currentThreshold.color) && thresholdDisplay === 'indicator') {
        return utils_UNSAFE_dvtCommonUtils.getDvtThresholdColor(currentThreshold.color);
    }
