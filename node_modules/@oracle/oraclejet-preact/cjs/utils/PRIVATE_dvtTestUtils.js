...
var utils_UNSAFE_matchTranslationBundle = require('./UNSAFE_matchTranslationBundle.js');
...
const setupTabbableComponent = async (component, isTabbable) => {
    ...
    if (isTabbable !== undefined) {
        return preact.render(jsxRuntime.jsx(UNSAFE_Environment.RootEnvironmentProvider, Object.assign({ environment: env }, { children: jsxRuntime.jsx(hooks_UNSAFE_useTabbableMode.TabbableModeContext.Provider, Object.assign({ value: { isTabbable: isTabbable } }, { children: component })) })));
    }
    else {
        return preact.render(jsxRuntime.jsx(UNSAFE_Environment.RootEnvironmentProvider, Object.assign({ environment: env }, { children: component })));
    }
};

exports["default"] = setupTabbableComponent;
/*  */
//# sourceMappingURL=PRIVATE_dvtTestUtils.js.map
