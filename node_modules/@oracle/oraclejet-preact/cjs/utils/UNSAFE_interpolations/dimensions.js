...
var _curry1$1 = require('../../_curry1-f1ebd742.js');
...
const dimensions = utils_UNSAFE_arrayUtils.stringLiteralArray([
    'height',
    'maxHeight',
    'maxWidth',
    'minHeight',
...
const propToSize = (key) => (props) => {
    ...
    return isNil_1(props[key]) ? {} : { [key]: utils_UNSAFE_size.sizeToCSS(val) };
};
