...
const keyAttr = 'value';
function DemoSelectMultiple({ assistiveText, data = items, helpSourceLink, helpSourceText, isDisabled, isReadonly, isRequired, label, labelEdge, messages, placeholder, textAlign, userAssistanceDensity, valueItems }) {
    var _a, _b;
    const [myValues, setMyValues] = hooks.useState();
    const [myValueItems, setMyValueItems] = hooks.useState(valueItems);
    const handleCommit = hooks.useCallback((detail) => {
        var _a;
        if (myValues != detail.value) {
            setMyValues(detail.value);
            const newValueItems = [];
            (_a = detail.value) === null || _a === void 0 ? void 0 : _a.forEach((key) => {
                const item = data === null || data === void 0 ? void 0 : data.find((element) => element[keyAttr] === key);
                if (item) {
                    newValueItems.push({
                        key: item[keyAttr],
                        data: item,
    ...
    jsxRuntime.jsx(SelectMultiple.SelectMultiple, { assistiveText: assistiveText, data: dataState, helpSourceLink: helpSourceLink, helpSourceText: helpSourceText, isDisabled: isDisabled, isReadonly: isReadonly, isRequired: isRequired, itemText: "label", label: label, labelEdge: labelEdge, messages: messages, onCommit: handleCommit, onFilter: handleFilter, onLoadRange: loadRange, placeholder: placeholder, textAlign: textAlign, userAssistanceDensity: userAssistanceDensity, valueItems: myValueItems }));
}
...
describe('Test SelectMultiple component:', () => {
    ...
    it('translation bundle', async () => {
        ...
        const content = preact.render(jsxRuntime.jsx(UNSAFE_Environment.RootEnvironmentProvider, Object.assign({ environment: env }, { children: jsxRuntime.jsx(SelectMultiple.SelectMultiple, { itemText: "label", label: "Enabled", labelEdge: "inside", valueItems: valueItems, onCommit: noOp }) })));
        const chip = await content.findByText('2');
        chai.expect(chip, 'initial selected values count shown').not.null;
        chai.expect(chip.getAttribute('aria-label')).equals('Enabled. 2 values selected. Show selected values only.');
    });
    it('initialize with valueItems', async function () {
        ...
        chai.expect(input, 'initial selected valueItems text shown').not.null;
    });
    it('programmatically change valueItems', async function () {
        ...
        const getComp = (valItems) => (jsxRuntime.jsx(UNSAFE_Environment.RootEnvironmentProvider, Object.assign({ environment: env }, { children: jsxRuntime.jsx(SelectMultiple.SelectMultiple, { itemText: "label", label: "Enabled", labelEdge: "inside", valueItems: valItems, onCommit: noOp }) })));
        const content = preact.render(getComp(valueItems));
        ...
        chai.expect(input, 'changed selected valueItems text shown').not.null;
    });
    it('shows moves UserAssistance correctly on focus', async () => {
        ...
        const { container, queryByText } = preact.render(jsxRuntime.jsxs("div", { children: [jsxRuntime.jsx(UNSAFE_Environment.RootEnvironmentProvider, Object.assign({ environment: env }, { children: jsxRuntime.jsx(SelectMultiple.SelectMultiple, { itemText: "label", label: "Enabled", labelEdge: "inside", assistiveText: "help instruction", onCommit: noOp }) })), jsxRuntime.jsx("button", {})] }));
    ...
    it('open dropdown on dropdown arrow click', async function () {
        ...
        const getComp = (valItems) => (jsxRuntime.jsx(UNSAFE_Environment.RootEnvironmentProvider, Object.assign({ environment: env }, { children: jsxRuntime.jsx(DemoSelectMultiple, { data: items, label: "Enabled", labelEdge: "inside", valueItems: valItems }) })));
        const content = preact.render(getComp(valueItems));
    ...
    it('selected values count shown', async function () {
        ...
        chai.expect(chip, 'changed selected values count shown').not.null;
    });
    it('click on selected values count chip to toggle dropdown selected-only mode', async function () {
        ...
        const content = preact.render(jsxRuntime.jsx(UNSAFE_Environment.RootEnvironmentProvider, Object.assign({ environment: env }, { children: jsxRuntime.jsx(DemoSelectMultiple, { data: items, label: "Enabled", labelEdge: "inside", valueItems: valueItems }) })));
        const chip = await content.findByText('2');
        chai.expect(chip, 'initial selected values count shown').not.null;
        // open dropdown in selected-only mode
        if (chip) {
            preact.fireEvent.click(chip);
        }
        let dropdown = await content.findByText('Firefox');
        chai.expect(dropdown, 'selected dropdown list item found in selected-only list').not.null;
        dropdown = content.queryByText('Opera');
        chai.expect(dropdown, 'unselected dropdown list item not found in selected-only list').null;
        // switch dropdown to full list
        if (chip) {
            preact.fireEvent.click(chip);
        }
        dropdown = await content.findByText('Opera');
        chai.expect(dropdown, 'unselected dropdown list item found in full list').not.null;
    });
    ...
    it('JET-53183 - propagation not stopped for Enter keydown in input', async function () {
        ...
        const getComp = (valItems) => (jsxRuntime.jsx(UNSAFE_Environment.RootEnvironmentProvider, Object.assign({ environment: env }, { children: jsxRuntime.jsx("div", Object.assign({ onKeyDown: handleKeyDown }, { children: jsxRuntime.jsx(DemoSelectMultiple, { data: items, label: "Enabled", labelEdge: "inside", valueItems: valItems }) })) })));
        const content = preact.render(getComp(valueItems));
        const input = await content.findByRole('combobox');
        chai.expect(input, 'input element found').not.null;
    ...
    it('JET-53183 - propagation not stopped for Tab keydown in input when no selected values count chip', async function () {
        ...
        const getComp = () => (jsxRuntime.jsx(UNSAFE_Environment.RootEnvironmentProvider, Object.assign({ environment: env }, { children: jsxRuntime.jsx("div", Object.assign({ onKeyDown: handleKeyDown }, { children: jsxRuntime.jsx(DemoSelectMultiple, { data: items, label: "Enabled", labelEdge: "inside" }) })) })));
    ...
    it('JET-53183 - propagation stopped for Enter keydown in selected values count chip', async function () {
        ...
        const content = preact.render(getComp(valueItems));
        const chip = await content.findByText('2');
        chai.expect(chip, 'selected values count chip found').not.null;
        preact.fireEvent.keyDown(chip, { code: PRIVATE_SelectCommon.KEYS.ENTER });
        chai.expect(keyDownReceived, 'propagation stopped').to.be.false;
    });
    it('JET-53183 - propagation not stopped for Esc keydown in selected values count chip when dropdown closed', async function () {
        ...
        const chip = await content.findByText('2');
        chai.expect(chip, 'selected values count chip found').not.null;
        preact.fireEvent.keyDown(chip, { code: PRIVATE_SelectCommon.KEYS.ESC });
        chai.expect(keyDownReceived, 'propagation not stopped').to.be.true;
    });
    ...
    it('JET-53183 - propagation stopped for Shift+Tab keydown in selected values count chip', async function () {
        ...
        const chip = await content.findByText('2');
        chai.expect(chip, 'selected values count chip found').not.null;
        preact.fireEvent.keyDown(chip, { code: PRIVATE_SelectCommon.KEYS.TAB, shiftKey: true });
        chai.expect(keyDownReceived, 'propagation stopped').to.be.false;
    });
    it('JET-53183 - propagation not stopped for Tab keydown in selected values count chip', async function () {
        ...
        const chip = await content.findByText('2');
        chai.expect(chip, 'selected values count chip found').not.null;
        preact.fireEvent.keyDown(chip, { code: PRIVATE_SelectCommon.KEYS.TAB });
        chai.expect(keyDownReceived, 'propagation not stopped').to.be.true;
    });
    afterEach(preact.cleanup);
});
/*  */
//# sourceMappingURL=SelectMultiple.spec.js.map
