...
describe('TextAreaAutosize - remaining text counter', () => {
    it('verifies counter text is shown by default', async () => {
        ...
        const { container } = preact.render(jsxRuntime.jsx(UNSAFE_Environment.RootEnvironmentProvider, Object.assign({ environment: env }, { children: jsxRuntime.jsx(TextAreaAutosize.TextAreaAutosize, { ariaDescribedBy: "testId", label: "Test Label", value: "1234", maxLength: 50, onInput: noOp }) })));
        const textAreaElement = container.querySelector('textarea');
        const siblingElement = textAreaElement === null || textAreaElement === void 0 ? void 0 : textAreaElement.nextElementSibling;
        const children = siblingElement === null || siblingElement === void 0 ? void 0 : siblingElement.children;
        const childSpanElement = children && children.length !== 0 ? children[0] : null;
        chai.expect(childSpanElement).not.to.be.null;
        chai.expect(childSpanElement === null || childSpanElement === void 0 ? void 0 : childSpanElement.tagName).to.equal('SPAN');
        chai.expect(childSpanElement === null || childSpanElement === void 0 ? void 0 : childSpanElement.textContent).to.equal('4/50');
    });
    it('verifies counter text is shown for maxLengthCounter == "remaining"', async () => {
        const env = await getEnvironmentContext();
        const { container } = preact.render(jsxRuntime.jsx(UNSAFE_Environment.RootEnvironmentProvider, Object.assign({ environment: env }, { children: jsxRuntime.jsx(TextAreaAutosize.TextAreaAutosize, { ariaDescribedBy: "testId", label: "Test Label", value: "1234", maxLength: 50, maxLengthCounter: "remaining", onInput: noOp }) })));
        const textAreaElement = container.querySelector('textarea');
        const siblingElement = textAreaElement === null || textAreaElement === void 0 ? void 0 : textAreaElement.nextElementSibling;
        const children = siblingElement === null || siblingElement === void 0 ? void 0 : siblingElement.children;
        const childSpanElement = children && children.length !== 0 ? children[0] : null;
    ...
    it('verifies counter text is not shown for maxLengthCounter == "none"', async () => {
        const env = await getEnvironmentContext();
        const { container } = preact.render(jsxRuntime.jsx(UNSAFE_Environment.RootEnvironmentProvider, Object.assign({ environment: env }, { children: jsxRuntime.jsx(TextAreaAutosize.TextAreaAutosize, { ariaDescribedBy: "testId", label: "Test Label", value: "1234", maxLength: 50, maxLengthCounter: "none", onInput: noOp }) })));
        const textAreaElement = container.querySelector('textarea');
        const siblingElement = textAreaElement === null || textAreaElement === void 0 ? void 0 : textAreaElement.nextElementSibling;
        const children = siblingElement === null || siblingElement === void 0 ? void 0 : siblingElement.children;
        const childSpanElement = children && children.length !== 0 ? children[0] : null;
        chai.expect(childSpanElement).to.be.null;
    });
    afterEach(preact.cleanup);
});
describe('TextAreaAutosize - verify readonly element type in enabled form layout', () => {
    const enabledFormContext = {
        isFormLayout: true
    };
    it('verifies text field inputelement type is "textarea" when maxRows is specified and component is enabled', async () => {
        const { container } = preact.render(jsxRuntime.jsx(hooks_UNSAFE_useFormContext.FormContext.Provider, Object.assign({ value: enabledFormContext }, { children: jsxRuntime.jsx(TextAreaAutosize.TextAreaAutosize, { label: "Test Label", value: "1234", maxRows: 5, onInput: noOp }) })));
        const textAreaElement = container.querySelector('textarea');
    ...
    it('verifies text field inputelement type is "textarea" when maxRows is specified and component is readonly', async () => {
        const { container } = preact.render(jsxRuntime.jsx(hooks_UNSAFE_useFormContext.FormContext.Provider, Object.assign({ value: enabledFormContext }, { children: jsxRuntime.jsx(TextAreaAutosize.TextAreaAutosize, { label: "Test Label", value: "1234", isReadonly: true, maxRows: 5, onInput: noOp }) })));
        const textAreaElement = container.querySelector('textarea');
        chai.expect(textAreaElement).not.to.be.null;
    });
    it('verifies text field input element type is not "textarea" when maxRows is not specified and component is enabled', async () => {
        const { container } = preact.render(jsxRuntime.jsx(hooks_UNSAFE_useFormContext.FormContext.Provider, Object.assign({ value: enabledFormContext }, { children: jsxRuntime.jsx(TextAreaAutosize.TextAreaAutosize, { label: "Test Label", value: "1234", onInput: noOp }) })));
        const textAreaElement = container.querySelector('textarea');
        chai.expect(textAreaElement).not.to.be.null;
    });
    it('verifies text field input element type is not "textarea" when maxRows is not specified and component is readonly', async () => {
        const { container } = preact.render(jsxRuntime.jsx(hooks_UNSAFE_useFormContext.FormContext.Provider, Object.assign({ value: enabledFormContext }, { children: jsxRuntime.jsx(TextAreaAutosize.TextAreaAutosize, { label: "Test Label", value: "1234", isReadonly: true, onInput: noOp }) })));
        const textAreaElement = container.querySelector('textarea');
        chai.expect(textAreaElement).to.be.null;
    });
    afterEach(preact.cleanup);
});
describe('TextAreaAutosize - verify readonly element type in readonly form layout', () => {
    const readonlyFormContext = {
        isFormLayout: true,
        isReadonly: true
    };
    it('verifies text field inputelement type is "textarea" when maxRows is specified and component is enabled', async () => {
        const { container } = preact.render(jsxRuntime.jsx(hooks_UNSAFE_useFormContext.FormContext.Provider, Object.assign({ value: readonlyFormContext }, { children: jsxRuntime.jsx(TextAreaAutosize.TextAreaAutosize, { label: "Test Label", value: "1234", maxRows: 5, onInput: noOp }) })));
        const textAreaElement = container.querySelector('textarea');
        chai.expect(textAreaElement).not.to.be.null;
    });
    it('verifies text field inputelement type is "textarea" when maxRows is specified and component is readonly', async () => {
        const { container } = preact.render(jsxRuntime.jsx(hooks_UNSAFE_useFormContext.FormContext.Provider, Object.assign({ value: readonlyFormContext }, { children: jsxRuntime.jsx(TextAreaAutosize.TextAreaAutosize, { label: "Test Label", value: "1234", isReadonly: true, maxRows: 5, onInput: noOp }) })));
        const textAreaElement = container.querySelector('textarea');
        chai.expect(textAreaElement).not.to.be.null;
    });
    it('verifies text field input element type is not "textarea" when maxRows is not specified and component is enabled', async () => {
        const { container } = preact.render(jsxRuntime.jsx(hooks_UNSAFE_useFormContext.FormContext.Provider, Object.assign({ value: readonlyFormContext }, { children: jsxRuntime.jsx(TextAreaAutosize.TextAreaAutosize, { label: "Test Label", value: "1234", onInput: noOp }) })));
        const textAreaElement = container.querySelector('textarea');
        chai.expect(textAreaElement).to.be.null;
    });
    it('verifies text field input element type is not "textarea" when maxRows is not specified and component is readonly', async () => {
        const { container } = preact.render(jsxRuntime.jsx(hooks_UNSAFE_useFormContext.FormContext.Provider, Object.assign({ value: readonlyFormContext }, { children: jsxRuntime.jsx(TextAreaAutosize.TextAreaAutosize, { label: "Test Label", value: "1234", isReadonly: true, onInput: noOp }) })));
        const textAreaElement = container.querySelector('textarea');
        chai.expect(textAreaElement).to.be.null;
    });
    afterEach(preact.cleanup);
...
describe('TextAreaAutosize - verify readonly element type when not in form layout', () => {
    it('verifies text field inputelement type is "textarea" when maxRows is specified and component is enabled', async () => {
        const { container } = preact.render(jsxRuntime.jsx(TextAreaAutosize.TextAreaAutosize, { label: "Test Label", value: "1234", maxRows: 5, onInput: noOp }));
        const textAreaElement = container.querySelector('textarea');
        chai.expect(textAreaElement).not.to.be.null;
    });
    it('verifies text field inputelement type is "textarea" when maxRows is specified and component is readonly', async () => {
        const { container } = preact.render(jsxRuntime.jsx(TextAreaAutosize.TextAreaAutosize, { label: "Test Label", value: "1234", isReadonly: true, maxRows: 5, onInput: noOp }));
        const textAreaElement = container.querySelector('textarea');
        chai.expect(textAreaElement).not.to.be.null;
    });
    it('verifies text field input element type is not "textarea" when maxRows is not specified and component is enabled', async () => {
        const { container } = preact.render(jsxRuntime.jsx(TextAreaAutosize.TextAreaAutosize, { label: "Test Label", value: "1234", onInput: noOp }));
        const textAreaElement = container.querySelector('textarea');
        chai.expect(textAreaElement).not.to.be.null;
    });
    it('verifies text field input element type is not "textarea" when maxRows is not specified and component is readonly', async () => {
        const { container } = preact.render(jsxRuntime.jsx(TextAreaAutosize.TextAreaAutosize, { label: "Test Label", value: "1234", isReadonly: true, onInput: noOp }));
        const textAreaElement = container.querySelector('textarea');
        chai.expect(textAreaElement).to.be.null;
    });
    afterEach(preact.cleanup);
...
/*  */
//# sourceMappingURL=TextAreaAutosize.spec.js.map
