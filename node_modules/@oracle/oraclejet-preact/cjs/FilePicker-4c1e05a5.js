...
var Spacer = require('./Spacer-6f567a4e.js');
var stringUtils = require('./stringUtils-dad38408.js');
var utils_UNSAFE_filePickerUtils = require('./utils/UNSAFE_filePickerUtils.js');
...
const getDefaultTriggerContent = (isDisabled, primaryText, secondaryText, translations, selectionMode) => {
    return [
        jsxRuntime.jsx(Text.Text, Object.assign({ variant: isDisabled ? 'disabled' : 'primary', weight: "bold", size: "xl" }, { children: getPrimaryText(primaryText, translations) })),
        jsxRuntime.jsx(Spacer.Spacer, { height: "1.5x" }),
        jsxRuntime.jsx(Text.Text, Object.assign({ variant: isDisabled ? 'disabled' : 'secondary', size: "sm" }, { children: getSecondaryText(secondaryText, translations, selectionMode) }))
    ];
};
...
const getStyles = (width, height) => {
    const dimStyles = {
        width: width ? utils_UNSAFE_size.sizeToCSS(width) : undefined,
        height: height ? utils_UNSAFE_size.sizeToCSS(height) : undefined
    };
    return dimStyles;
};
/**
...
const useFilepickerElementHelper = (props, rootRef, setValidity) => {
    ...
    const { pressProps } = hooks_UNSAFE_usePress.usePress(callback);
    ...
    const { hoverProps, isHover } = hooks_UNSAFE_useHover.useHover({ isDisabled: false });
    return {
        validation,
        dragAndDropProps,
        pressProps,
...
const clickCallbackUtils = (props) => {
    ...
    const handleSelectingFiles = (event) => {
        ...
        if (event.type === 'click' ||
            ...
            utils_UNSAFE_filePickerUtils.pickFiles(_handleClickValidation, {
                accept: props.accept,
...
function FilePicker(_a) {
  var {
    ...
    children
      ...
      otherProps = tslib_es6.__rest(_a, ["capture", "isDisabled", "selectionMode", "children"]); // this ref is added only for testing purposes.  Allows the test to directly
  ...
  if (isDisabled) {
    return jsxRuntime.jsx(DisabledFilePicker, Object.assign({}, props, {
      children: children
    }));
  }

  return children ? jsxRuntime.jsx(CustomFilePicker, Object.assign({
    testHandlersRef: testHandlersRef
  }, props, {
    children: children
  })) : jsxRuntime.jsx(DefaultFilePicker, Object.assign({
    testHandlersRef: testHandlersRef
  }, props));
}
/**
...
const DefaultFilePicker = props => {
  const [validity, setValidity] = hooks.useState('NA'); // class added to change bg/border color based on if file is valid on drag and drop
  ...
  const mergedEventProps = utils_UNSAFE_mergeProps.mergeProps(pressProps, hoverProps); // These are backdoor handles that are used for testing purposes only

  useSetupTestRef(dragAndDropProps, validation, props.testHandlersRef || null);
  const classes = classNames.classNames([styles.base, props.width === undefined && styles.maxWidth, isHover && styles.hover]);
  const {
    isTabbable
  ...
  return jsxRuntime.jsx("div", Object.assign({}, mergedEventProps, {
    class: classes,
    ...
    children: jsxRuntime.jsx("div", Object.assign({
      class: classNames.classNames([styles.inner, validityClass])
    }, dragAndDropProps, {
...
const DisabledFilePicker = ({
  ...
  return jsxRuntime.jsx("div", Object.assign({
    class: classNames.classNames([childrenStyles, styles.base, styles.inner, width === undefined && styles.maxWidth, 'oj-c-filepicker-disabled']),
    role: "button",
    "aria-label": getAriaLabel({
      accessibleLabel,
      isDisabled: true,
...
const CustomFilePicker = props => {
  ...
  const mergedEventProps = utils_UNSAFE_mergeProps.mergeProps(pressProps, dragAndDropProps, hoverProps); // These are backdoor handles that are used for testing purposes only
  ...
  return jsxRuntime.jsx("div", Object.assign({
    class: classNames.classNames([classes, childrenStyles]),
...
/*  */
//# sourceMappingURL=FilePicker-4c1e05a5.js.map
