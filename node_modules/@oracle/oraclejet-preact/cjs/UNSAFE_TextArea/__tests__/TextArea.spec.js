...
describe('TextArea - remaining text counter', () => {
    it('verifies counter text is shown by default', async () => {
        ...
        const { container } = preact.render(jsxRuntime.jsx(UNSAFE_Environment.RootEnvironmentProvider, Object.assign({ environment: env }, { children: jsxRuntime.jsx(TextArea.TextArea, { ariaDescribedBy: "testId", label: "Test Label", value: "1234", maxLength: 50, onInput: noOp }) })));
    ...
    it('verifies counter text is shown for maxLengthCounter == "remaining"', async () => {
        const env = await getEnvironmentContext();
        const { container } = preact.render(jsxRuntime.jsx(UNSAFE_Environment.RootEnvironmentProvider, Object.assign({ environment: env }, { children: jsxRuntime.jsx(TextArea.TextArea, { ariaDescribedBy: "testId", label: "Test Label", value: "1234", maxLength: 50, maxLengthCounter: "remaining", onInput: noOp }) })));
        const textAreaElement = container.querySelector('textarea');
        const siblingElement = textAreaElement === null || textAreaElement === void 0 ? void 0 : textAreaElement.nextElementSibling;
        const children = siblingElement === null || siblingElement === void 0 ? void 0 : siblingElement.children;
        const childSpanElement = children && children.length !== 0 ? children[0] : null;
    ...
    it('verifies counter text is not shown for maxLengthCounter == "none"', async () => {
        const env = await getEnvironmentContext();
        const { container } = preact.render(jsxRuntime.jsx(UNSAFE_Environment.RootEnvironmentProvider, Object.assign({ environment: env }, { children: jsxRuntime.jsx(TextArea.TextArea, { ariaDescribedBy: "testId", label: "Test Label", value: "1234", maxLength: 50, maxLengthCounter: "none", onInput: noOp }) })));
        const textAreaElement = container.querySelector('textarea');
        const siblingElement = textAreaElement === null || textAreaElement === void 0 ? void 0 : textAreaElement.nextElementSibling;
        const children = siblingElement === null || siblingElement === void 0 ? void 0 : siblingElement.children;
        const childSpanElement = children && children.length !== 0 ? children[0] : null;
