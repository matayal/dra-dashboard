...
require('../../UNSAFE_ListView.js');
var listViewTestFixtures = require('../../listViewTestFixtures-eb39b1f7.js');
var listViewSelectionTests = require('../../listViewSelectionTests-9cb118a1.js');
var ListView = require('../../ListView-178451ad.js');
...
require('chai');
require('../../utils/UNSAFE_matchTranslationBundle.js');
require('../../testHelpers-81b8b24e.js');

function TestComponent({ currentItemVariant, data, initialKey, gridlines, onItemAction, selectedKeys, selectionMode, onClick }) {
    const rootRef = hooks.useRef(null);
    const [currentKey, setCurrentKey] = hooks.useState(initialKey);
    const [selection, setSelection] = hooks.useState(selectedKeys);
    ...
    return (jsxRuntime.jsx("div", Object.assign({ style: "height: calc(10 * var(--oj-c-PRIVATE-DO-NOT-USE-core-spacing-5x));overflow: auto", ref: rootRef, onClick: () => {
            onClick && onClick();
        } }, { children: jsxRuntime.jsx(ListView.ListView, Object.assign({ accessibleSummary: "Basic list", data: dataState, currentKey: currentKey, selectedKeys: selection, selectionMode: selectionMode, viewportConfig: getConfig(), onCurrentKeyChange: (detail) => setCurrentKey(detail.value), onSelectionChange: (detail) => setSelection(detail.value), onLoadRange: loadRange, gridlines: gridlines, onItemAction: onItemAction, currentItemVariant: currentItemVariant }, { children: (context) => (jsxRuntime.jsxs(Flex.Flex, { children: [context.selector && context.selector(), jsxRuntime.jsx("div", Object.assign({ className: "item", style: {
...
describe('Test ListView component', () => {
    ...
    // bind shared tests
    listViewSelectionTests.testRender.bind(undefined)(TestComponent);
    listViewSelectionTests.testAria.bind(undefined)(TestComponent);
    listViewSelectionTests.testKeys.bind(undefined)(TestComponent);
    listViewSelectionTests.testGridlines.bind(undefined)(TestComponent);
    listViewSelectionTests.testItemAction.bind(undefined)(TestComponent);
    // selection tests
    listViewSelectionTests.testSelection.bind(undefined)(TestComponent);
});
/*  */
//# sourceMappingURL=ListView.spec.js.map
