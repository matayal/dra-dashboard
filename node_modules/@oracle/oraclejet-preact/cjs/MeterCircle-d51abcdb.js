...
function CircularReferenceLine({
  color,
  angle,
  radius,
  length,
  ...
  return jsxRuntime.jsx("div", {
    ...
    style: {
      ...
      backgroundColor: color ? utils_UNSAFE_dvtCommonUtils.getDvtThresholdColor(color) : 'var(--oj-c-PRIVATE-DO-NOT-USE-dvt-reference-object-line-color)',
...
function getDimensions(element, section) {
    ...
    return Object.assign({ width: Math.round(rect.width), height: Math.round(rect.height) }, getInnerAndOuterRadius(circleTrack, rect, section));
}
/**
...
function MeterCircle(_a) {
  ...
  var {
    ...
    indicatorSize = 1
      ...
      props = tslib_es6.__rest(_a, ["max", "min", "value", "step", "size", "startAngle", "angleExtent", "isTrackRendered", "thresholdDisplay", "indicatorSize"]);
  ...
  const pointerEventsProps = hooks_PRIVATE_useDvtMeterEvents.usePointerEvents(value, getValueFromEvent, circleWrapperRef, props.onCommit, props.onInput);
  ...
  const ariaProps = utils_PRIVATE_meterUtils.getMeterAriaProps(value, min, max, `${value}`, props.accessibleLabel, props.ariaLabelledBy, props.thresholds);
  ...
  const orientation = section === 'bottom' || section === 'top' ? 'Horizontal' : section === 'left' || section === 'right' ? 'Vertical' : 'Full';
  const meterInfo = {
    min,
    max,
    value,
  ...
  return jsxRuntime.jsxs(jsxRuntime.Fragment, {
    children: [jsxRuntime.jsx("div", Object.assign({
      class: classNames.classNames([component.base, isInteractive ? component.interactive : '']),
      tabIndex: !isTabbable ? -1 : 0,
      role: "slider"
    }, mergedProps, {
      children: jsxRuntime.jsxs(PRIVATE_Meter.CircleWrapper, Object.assign({
        ref: circleWrapperRef,
        class: classNames.classNames([circleWrapper.base, props.referenceLines && props.referenceLines.length > 0 ? styles[`${size}${section}`] : '', styles[`${size}${orientation}`]])
      }, {
        children: [jsxRuntime.jsx(PRIVATE_Meter.CircleInner, Object.assign({
          class: classNames.classNames([circleTrack.base, styles[section]])
        }, getTrackProps(meterInfo, isTrackRendered, thresholdDisplay, trackColor, props.innerRadius, props.thresholds))), thresholdDisplay === 'all' && props.thresholds && getThresholdsProps(meterInfo, props.thresholds, isTrackRendered, trackColor, props.innerRadius).map(threshold => {
          return jsxRuntime.jsx(PRIVATE_Meter.CircleInner, Object.assign({
            class: classNames.classNames([circleTrack.base, styles[section], styles.thresholds])
          }, threshold));
        }), jsxRuntime.jsx(PRIVATE_Meter.CircleInner, Object.assign({
          color: indicatorColor,
          class: classNames.classNames([circleValue.base, circleValue[section], styles[section]])
        }, getIndicatorProps(meterInfo, indicatorSize, props.innerRadius))), (_b = props.referenceLines) === null || _b === void 0 ? void 0 : _b.map(refLine => {
          return jsxRuntime.jsx(CircularReferenceLine, Object.assign({}, getReferenceLinesProps(meterInfo, refLine, props.innerRadius), {
            section: section
          }));
        }), isDimsReady && props.children && centerContext && jsxRuntime.jsx("div", Object.assign({
          class: classNames.classNames([styles.centerContent, childrenStyles])
        }, {
          children: props.children(centerContext)
        }))]
      }))
    })), datatipContent]
  });
...
const styles = {
  ...
  mdfull: "_1qxbpvm",
  lgfull: "gz24ll",
  lgHorizontal: "_1x6rqzc",
  lgVertical: "r15buq",
  smHorizontal: "mif2xu",
  smVertical: "_1qurat1",
  mdHorizontal: "_4o8f3c",
  mdVertical: "hzmesc",
  smFull: "ph5fbl",
  mdFull: "mzln8",
  lgFull: "wzkuab",
  centerContent: "purbfb",
  thresholds: "_1r48edm"
};
const childrenStyles = "_1ebwq2x";
const circleWrapper = {
  base: "_5hh72v"
};
const circleTrack = {
...
/*  */
//# sourceMappingURL=MeterCircle-d51abcdb.js.map
