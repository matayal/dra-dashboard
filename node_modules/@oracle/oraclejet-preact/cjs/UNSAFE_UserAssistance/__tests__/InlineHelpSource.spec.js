...
describe('InlineHelpSource - TabbableModeContext', () => {
    ...
    it('as input, TabbableModeContext not provided', async () => {
        ...
        const content = preact.render(jsxRuntime.jsx(UNSAFE_Environment.RootEnvironmentProvider, Object.assign({ environment: env }, { children: jsxRuntime.jsx(InlineHelpSource.InlineHelpSource, Object.assign({ source: "http://www.oracle.com" }, { children: value })) })));
        const anchorElement = await content.findByText(value);
        chai.expect(anchorElement).not.to.be.null;
        const tabindex = anchorElement === null || anchorElement === void 0 ? void 0 : anchorElement.getAttribute('tabindex');
        chai.expect(tabindex).to.be.null;
    });
    it('as input, TabbableModeContext isTabbable=true', async () => {
        const value = 'Help source';
        const content = preact.render(jsxRuntime.jsx(UNSAFE_Environment.RootEnvironmentProvider, Object.assign({ environment: env }, { children: jsxRuntime.jsx(hooks_UNSAFE_useTabbableMode.TabbableModeContext.Provider, Object.assign({ value: { isTabbable: true } }, { children: jsxRuntime.jsx(InlineHelpSource.InlineHelpSource, Object.assign({ source: "http://www.oracle.com" }, { children: value })) })) })));
        const anchorElement = await content.findByText(value);
        chai.expect(anchorElement).not.to.be.null;
        const tabindex = anchorElement === null || anchorElement === void 0 ? void 0 : anchorElement.getAttribute('tabindex');
        chai.expect(tabindex).to.be.null;
    ...
    it('as input, TabbableModeContext isTabbable=false', async () => {
        const value = 'Help source';
        const content = preact.render(jsxRuntime.jsx(UNSAFE_Environment.RootEnvironmentProvider, Object.assign({ environment: env }, { children: jsxRuntime.jsx(hooks_UNSAFE_useTabbableMode.TabbableModeContext.Provider, Object.assign({ value: { isTabbable: false } }, { children: jsxRuntime.jsx(InlineHelpSource.InlineHelpSource, Object.assign({ source: "http://www.oracle.com" }, { children: value })) })) })));
        const anchorElement = await content.findByText(value);
        chai.expect(anchorElement).not.to.be.null;
        const tabindex = anchorElement === null || anchorElement === void 0 ? void 0 : anchorElement.getAttribute('tabindex');
...
/*  */
//# sourceMappingURL=InlineHelpSource.spec.js.map
