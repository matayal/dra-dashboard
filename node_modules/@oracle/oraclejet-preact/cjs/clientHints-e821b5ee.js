...
function getClientHints(uaString) {
    ...
    if (cachedClientHints === undefined || uaString) {
        ...
        if (userAgentData) {
            ...
            hints = getHintsFromUserAgentString(uaString !== null && uaString !== void 0 ? uaString : (typeof navigator !== 'undefined' ? navigator.userAgent : ''));
        }
...
function getHintsFromUserAgentString(userAgent) {
    ...
    if (userAgent.indexOf('iphone') > -1) {
        ...
        (typeof navigator !== 'undefined' &&
            ...
            (navigator['standalone'] || navigator.maxTouchPoints > 1))) {
        hints.platform = 'ios';
        hints.deviceType = 'tablet';
    }
...
function determineTouchSupport(hints) {
    ...
    else if ((_a = window.matchMedia) === null || _a === void 0 ? void 0 : _a.call(window, '(pointer: coarse)').matches) {
        hints.touchSupport = 'primary';
    }
    // otherwise if ANY input pointer is 'coarse', then touch is a secondary input method
    else if ((_b = window.matchMedia) === null || _b === void 0 ? void 0 : _b.call(window, '(any-pointer: coarse)').matches) {
...
function determineHoverSupport(hints) {
    ...
    if (typeof window === 'undefined' || ((_a = window.matchMedia) === null || _a === void 0 ? void 0 : _a.call(window, '(hover: none)').matches)) {
    ...
    else if (hints.touchSupport !== 'none' && ((_b = window.matchMedia) === null || _b === void 0 ? void 0 : _b.call(window, '(pointer: fine)').matches)) {
...
/*  */
//# sourceMappingURL=clientHints-e821b5ee.js.map
