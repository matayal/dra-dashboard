...
const noOp = () => { };
function DemoInputPassword({ hasClearIcon, isDisabled, isReadonly, label }) {
    const [value, setValue] = hooks.useState('hello');
    return (jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [jsxRuntime.jsx(UNSAFE_InputPassword.InputPassword, { hasClearIcon: hasClearIcon, isDisabled: isDisabled, isReadonly: isReadonly, label: label, onInput: noOp, value: value }), jsxRuntime.jsx("button", Object.assign({ class: "testclickmebutton", onClick: () => setValue('goodbye') }, { children: "Click me" }))] }));
}
function DemoInputText({ hasClearIcon, isDisabled, isReadonly, label }) {
    const [value, setValue] = hooks.useState('hello');
    return (jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [jsxRuntime.jsx(UNSAFE_InputText.InputText, { hasClearIcon: hasClearIcon, isDisabled: isDisabled, isReadonly: isReadonly, label: label, onInput: noOp, value: value }), jsxRuntime.jsx("button", Object.assign({ class: "testclickmebutton", onClick: () => setValue('goodbye') }, { children: "Click me" }))] }));
}
...
describe('FormControlClearIcon.spec', () => {
    ...
    componentWithClearIconList.forEach(function (compObj) {
        ...
        it(`${compObj.name} hasClearIcon 'conditionally', no value, focusin/focusout`, async () => {
            ...
            const { container } = preact.render(jsxRuntime.jsxs(UNSAFE_Environment.RootEnvironmentProvider, Object.assign({ environment: env }, { children: [jsxRuntime.jsx(compObj.component, { hasClearIcon: "conditionally", label: label }), jsxRuntime.jsx("button", Object.assign({ class: "testclickmebutton" }, { children: "Click me" }))] })));
            ...
            chai.expect(clearIcon, 'clear icon not found').null;
        });
        ...
        it(`${compObj.name} hasClearIcon 'always', check icon`, async () => {
            const label = 'field label';
            const { container } = preact.render(jsxRuntime.jsxs(UNSAFE_Environment.RootEnvironmentProvider, Object.assign({ environment: env }, { children: [jsxRuntime.jsx(compObj.component, { hasClearIcon: "always", label: label }), jsxRuntime.jsx("button", Object.assign({ class: "testclickmebutton" }, { children: "Click me" }))] })));
            const inputElement = container.querySelector('input');
            chai.expect(inputElement.value).equal('hello');
            const clearIconSelector = '[title="Clear"]';
            // Get the parent element of the svg icon which contains
        ...
        it(`${compObj.name} hasClearIcon 'always', with value, focusin/focusout`, async () => {
            ...
            // all the event listeners
            const clearIcon = container.querySelector(clearIconSelector);
            chai.expect(clearIcon, 'clear icon found even if no value is in the field').not.null;
        });
        it(`${compObj.name} hasClearIcon 'always', isReadonly true`, async () => {
            const label = 'field label';
            const { container } = preact.render(jsxRuntime.jsxs(UNSAFE_Environment.RootEnvironmentProvider, Object.assign({ environment: env }, { children: [jsxRuntime.jsx(compObj.component, { hasClearIcon: "always", isReadonly: true, label: label }), jsxRuntime.jsx("button", Object.assign({ class: "testclickmebutton" }, { children: "Click me" }))] })));
            const clearIconSelector = '[title="Clear"]';
            // Get the parent element of the svg icon which contains
            // all the event listeners
            const clearIcon = container.querySelector(clearIconSelector);
            chai.expect(clearIcon, 'clear icon not found for readonly component').null;
        });
        it(`${compObj.name} hasClearIcon 'always', isDisabled true`, async () => {
            const label = 'field label';
            const { container } = preact.render(jsxRuntime.jsxs(UNSAFE_Environment.RootEnvironmentProvider, Object.assign({ environment: env }, { children: [jsxRuntime.jsx(compObj.component, { hasClearIcon: "always", isDisabled: true, label: label }), jsxRuntime.jsx("button", Object.assign({ class: "testclickmebutton" }, { children: "Click me" }))] })));
            const clearIconSelector = '[title="Clear"]';
            // Get the parent element of the svg icon which contains
            // all the event listeners
            const clearIcon = container.querySelector(clearIconSelector);
            chai.expect(clearIcon, 'clear icon not found for disabled component').null;
        });
        it(`${compObj.name} hasClearIcon 'always', focusin`, async () => {
            ...
            // all the event listeners
            const clearIcon = container.querySelector(clearIconSelector);
            chai.expect(clearIcon, 'clear icon found, so this should not be null').not.null;
        });
        // never
        it(`${compObj.name} hasClearIcon 'never', check icon`, async () => {
            const label = 'field label';
            const { container } = preact.render(jsxRuntime.jsxs(UNSAFE_Environment.RootEnvironmentProvider, Object.assign({ environment: env }, { children: [jsxRuntime.jsx(compObj.component, { hasClearIcon: "never", label: label }), jsxRuntime.jsx("button", Object.assign({ class: "testclickmebutton" }, { children: "Click me" }))] })));
            const inputElement = container.querySelector('input');
            chai.expect(inputElement.value).equal('hello');
            const clearIconSelector = '[title="Clear"]';
            // Get the parent element of the svg icon which contains
        ...
        it(`${compObj.name} hasClearIcon 'never', isReadonly comp`, async () => {
            const label = 'field label';
            const { container } = preact.render(jsxRuntime.jsxs(UNSAFE_Environment.RootEnvironmentProvider, Object.assign({ environment: env }, { children: [jsxRuntime.jsx(compObj.component, { hasClearIcon: "never", isReadonly: true, label: label }), jsxRuntime.jsx("button", Object.assign({ class: "testclickmebutton" }, { children: "Click me" }))] })));
            const clearIconSelector = '[title="Clear"]';
            // Get the parent element of the svg icon which contains
            // all the event listeners
            const clearIcon = container.querySelector(clearIconSelector);
        ...
        it(`${compObj.name} hasClearIcon 'never', isDisabled comp`, async () => {
            const label = 'field label';
            const { container } = preact.render(jsxRuntime.jsxs(UNSAFE_Environment.RootEnvironmentProvider, Object.assign({ environment: env }, { children: [jsxRuntime.jsx(compObj.component, { hasClearIcon: "never", isDisabled: true, label: label }), jsxRuntime.jsx("button", Object.assign({ class: "testclickmebutton" }, { children: "Click me" }))] })));
            const clearIconSelector = '[title="Clear"]';
            // Get the parent element of the svg icon which contains
            // all the event listeners
            const clearIcon = container.querySelector(clearIconSelector);
        ...
        it(`${compObj.name} hasClearIcon not specified, focus comp`, async () => {
            const label = 'field label';
            const { container } = preact.render(jsxRuntime.jsxs(UNSAFE_Environment.RootEnvironmentProvider, Object.assign({ environment: env }, { children: [jsxRuntime.jsx(compObj.component, { label: label }), jsxRuntime.jsx("button", Object.assign({ class: "testclickmebutton" }, { children: "Click me" }))] })));
            const inputElement = container.querySelector('input');
            preact.act(() => {
                inputElement.focus();
            });
...
/*  */
//# sourceMappingURL=FormControlClearIcon.spec.js.map
