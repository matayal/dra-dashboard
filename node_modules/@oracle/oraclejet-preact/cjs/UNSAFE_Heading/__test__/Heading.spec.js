...
var Heading = require('../../Heading-5dd30def.js');
...
describe('Test Heading component', () => {
    it('default Heading', async function () {
        var _a;
        const content = preact.render(jsxRuntime.jsx(Heading.Heading, Object.assign({ as: "h1" }, { children: "Hello world" })));
        const h1 = await content.findByText('Hello world');
        const classList = (_a = h1.parentElement) === null || _a === void 0 ? void 0 : _a.classList;
        chai.expect(h1).not.null;
        chai.expect(classList === null || classList === void 0 ? void 0 : classList.length).equals(2);
    });
    it('heading text lineClamp applies css class and lineClamp value', async () => {
        var _a, _b;
        const content = preact.render(jsxRuntime.jsx(Heading.Heading, Object.assign({ as: "h1" }, { children: jsxRuntime.jsx(Text.Text, Object.assign({ lineClamp: 4 }, { children: "Hello world with lineClamp" })) })));
    ...
    it('Heading text truncation applies css class', async () => {
        var _a;
        const content = preact.render(jsxRuntime.jsx(Heading.Heading, Object.assign({ as: "h1" }, { children: jsxRuntime.jsx(Text.Text, Object.assign({ truncation: "ellipsis" }, { children: "Hello world" })) })));
    ...
    it('Heading link applies default CSS classes', async function () {
        const content = preact.render(jsxRuntime.jsx(Heading.Heading, Object.assign({ as: "h1" }, { children: jsxRuntime.jsx(Link.Link, Object.assign({ href: "#" }, { children: "Link" })) })));
    ...
    it('Heading link variant selected', async function () {
        const content = preact.render(jsxRuntime.jsx(Heading.Heading, Object.assign({ as: "h1" }, { children: jsxRuntime.jsx(Link.Link, Object.assign({ href: "#", variant: "primary" }, { children: "Link" })) })));
        const firstElement = await content.findByText('Link');
        // @ts-ignore
        const classList = firstElement.classList;
    ...
    it('Heading link event', async function () {
        ...
        const content = preact.render(jsxRuntime.jsx(Heading.Heading, Object.assign({ as: "h1" }, { children: jsxRuntime.jsx(Link.Link, Object.assign({ href: "#", onClick: increment }, { children: "Link" })) })));
    ...
    it('has id property', async function () {
        var _a;
        const content = preact.render(jsxRuntime.jsx(Heading.Heading, Object.assign({ as: "h1", id: "heading1" }, { children: "Heading 1" })));
        const heading = await content.findByText('Heading 1');
        const id = (_a = heading.parentElement) === null || _a === void 0 ? void 0 : _a.getAttribute('id');
        chai.expect(id).to.equal('heading1');
    });
});
/*  */
