...
const placeholderTypes = utils_UNSAFE_arrayUtils.stringLiteralArray(['topPlaceholder', 'bottomPlaceholder']);
...
const Placeholder = ({ context, placeholderHeight }) => {
    ...
    return jsxRuntime.jsx("div", { className: PLACEHOLDER_STYLE_CLASS, style: style }, key);
};
...
function VirtualizedCollection({ data, children, viewportConfig, itemSelector, placeholderHeight, rangeExtractor = DEFAULT_RANGE_EXTRACTOR, overscan = DEFAULT_OVERSCAN, onLoadRange, loadMoreIndicator, suggestions }) {
    ...
    const estimateItemSizeRef = hooks.useRef(0);
    // detect if viewport has changed and it needs to re-render based on a new range
    hooks_UNSAFE_useViewportIntersect.useViewportIntersect(viewportConfig, DEFAULT_MARGIN, LOAD_MORE_AND_PLACEHOLDER_SELECTOR, () => {
        var _a;
    ...
    const topPlaceholderContext = offset >= 0
        ? {
            ...
            estimateItemSize: (_a = estimateItemSizeRef.current) !== null && _a !== void 0 ? _a : 0
        }
        : undefined;
    ...
    return (jsxRuntime.jsxs("div", Object.assign({ ref: rootRef, style: "will-change: contents" }, { children: [suggestions, topPlaceholderContext && (jsxRuntime.jsx(Placeholder, { context: topPlaceholderContext, placeholderHeight: placeholderHeight })), jsxRuntime.jsx(Collection.Collection, Object.assign({ items: rangeData }, { children: _getItemRenderer(offset) })), bottomPlaceholderContext && (jsxRuntime.jsx(Placeholder, { context: bottomPlaceholderContext, placeholderHeight: placeholderHeight })), renderLoadMore && jsxRuntime.jsx("div", Object.assign({ class: LOADMORE_STYLE_CLASS }, { children: loadMoreIndicator }))] })));
}
...
/*  */
//# sourceMappingURL=VirtualizedCollection-19e514e1.js.map
