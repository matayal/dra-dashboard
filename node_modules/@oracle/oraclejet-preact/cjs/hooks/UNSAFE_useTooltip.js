...
const TooltipContent = _a => {
  var {
    ...
    onTransitionEnd
      ...
      props = tslib_es6.__rest(_a, ["children", "isOpen", "isDatatip", "onTransitionEnd"]);
  ...
  const {
    nodeRef
  } = useAnimation.useAnimation(isOpen ? 'mounted' : 'unmounted', {
    animationStates: {
      mounted: _node => {
  ...
  return jsxRuntime.jsx("div", Object.assign({
    ...
    children: jsxRuntime.jsx("div", Object.assign({
      ref: nodeRef,
      class: classNames.classNames([styles.inner])
    }, props, {
      children: jsxRuntime.jsx("div", Object.assign({
        ref: popoverRef,
        class: classNames.classNames([styles.base, isDatatip ? styles.datatip : ''])
      }, {
        children: children
      }))
    }))
...
const useTooltipControlled = ({ text, isOpen = false, variant = 'tooltip', position = 'bottom', isDisabled = false, anchor = { x: 'element', y: 'element' }, offset = { mainAxis: 0, crossAxis: 0 }, onToggle }) => {
    ...
    const coordsRef = hooks.useRef({ x: 0, y: 0 });
    ...
    */
    ...
    if (disabled) {
        ...
        actionableProps = utils_UNSAFE_mergeProps.mergeProps(hoverProps, focusProps, touchProps, hoverInitProps, focusInitProps, anchorInitProps);
    }
    ...
    const renderContent = (jsxRuntime.jsx(UNSAFE_Layer.Layer, Object.assign({ logicalParentRef: targetRef }, { children: jsxRuntime.jsx(Floating.Floating, Object.assign({ anchorRef: usedRef, placement: placement, offsetValue: offset }, { children: jsxRuntime.jsx(TooltipContent, Object.assign({ isOpen: ['mounting', 'mounted', 'unmountPending'].includes(state) }, popoverHoverProps, { isDatatip: isDatatip, onTransitionEnd: handleTransitionEnd }, { children: text })) })) })));
    return {
