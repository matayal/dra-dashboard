...
function ButtonLayout(_a) {
  var {
    ...
    styling = 'default'
      ...
      props = tslib_es6.__rest(_a, ["size", "display", "styling"]);
  ...
  const startIconStyles = classNames.classNames([compStyles.icon, isEmbedded ? `oj-c-button-layout-embedded-${size}` : `oj-c-button-layout-${size}`, !isOnlyIcon && compStyles.startIcon]);
...
const Button = compat.forwardRef(({ variant = 'outlined', isDisabled = false, isRepeat = false, size = 'md', display = 'all', endIcon, startIcon, autofocus, edge, onAction, label = '', accessibleLabel, title, 'aria-describedby': ariaDescribedBy, width, onBlur, onFocus, onMouseEnter, onMouseLeave, onTouchEnd, onTouchStart }, ref) => {
...
/*  */
//# sourceMappingURL=Button-07d97191.js.map
